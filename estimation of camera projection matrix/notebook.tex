...
{\color{incolor}In [{\color{incolor}11}]:} \PY{k+kn}{import} \PY{n+nn}{numpy} \PY{k}{as} \PY{n+nn}{np}
         ...
         \PY{k}{def} \PY{n+nf}{computeP\PYZus{}DLT}\PY{p}{(}\PY{n}{x}\PY{p}{,}\PY{n}{X}\PY{p}{)}\PY{p}{:}
             ...
             \PY{n}{x\PYZus{}nl}\PY{o}{=}\PY{n}{x\PYZus{}homo}
             \PY{n}{X\PYZus{}nl}\PY{o}{=}\PY{n}{X\PYZus{}homo}
             
             \PY{n}{v}\PY{o}{=}\PY{n}{np}\PY{o}{.}\PY{n}{zeros}\PY{p}{(}\PY{p}{(}\PY{l+m+mi}{3}\PY{p}{,}\PY{l+m+mi}{50}\PY{p}{)}\PY{p}{)}
             \PY{n}{A}\PY{o}{=}\PY{n}{np}\PY{o}{.}\PY{n}{zeros}\PY{p}{(}\PY{p}{(}\PY{l+m+mi}{2}\PY{o}{*}\PY{l+m+mi}{50}\PY{p}{,}\PY{l+m+mi}{12}\PY{p}{)}\PY{p}{)}
             \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{l+m+mi}{50}\PY{p}{)}\PY{p}{:}
                 \PY{c+c1}{\PYZsh{}calculate v vector}
                 \PY{n}{v}\PY{p}{[}\PY{p}{:}\PY{p}{,}\PY{n}{i}\PY{p}{]}\PY{o}{=}\PY{p}{(}\PY{n}{x\PYZus{}nl}\PY{p}{[}\PY{p}{:}\PY{p}{,}\PY{n}{i}\PY{p}{]}\PY{o}{.}\PY{n}{reshape}\PY{p}{(}\PY{l+m+mi}{3}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{)}\PY{o}{+}\PY{n}{np}\PY{o}{.}\PY{n}{sign}\PY{p}{(}\PY{n}{x\PYZus{}nl}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{,}\PY{n}{i}\PY{p}{]}\PY{p}{)}\PY{o}{*}\PY{n}{np}\PY{o}{.}\PY{n}{sqrt}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{dot}\PY{p}{(}\PY{n}{x\PYZus{}nl}\PY{p}{[}\PY{p}{:}\PY{p}{,}\PY{n}{i}\PY{p}{]}\PYZbs{}
                 \PY{p}{,}\PY{n}{x\PYZus{}nl}\PY{p}{[}\PY{p}{:}\PY{p}{,}\PY{n}{i}\PY{p}{]}\PY{p}{)}\PY{p}{)}\PY{o}{*}\PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{p}{[}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{,}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{,}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{]}\PY{p}{)}\PY{p}{)}\PY{o}{.}\PY{n}{ravel}\PY{p}{(}\PY{p}{)} 
                 ...
                 \PY{n}{A}\PY{p}{[}\PY{l+m+mi}{2}\PY{o}{*}\PY{n}{i}\PY{p}{:}\PY{l+m+mi}{2}\PY{o}{*}\PY{n}{i}\PY{o}{+}\PY{l+m+mi}{2}\PY{p}{,}\PY{p}{:}\PY{p}{]}\PY{o}{=}\PY{n}{np}\PY{o}{.}\PY{n}{kron}\PY{p}{(}\PY{n}{H\PYZus{}v}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{:}\PY{l+m+mi}{3}\PY{p}{,}\PY{p}{:}\PY{p}{]}\PY{p}{,}\PY{n}{X\PYZus{}nl}\PY{p}{[}\PY{p}{:}\PY{p}{,}\PY{n}{i}\PY{p}{]}\PY{o}{.}\PY{n}{reshape}\PY{p}{(}\PY{l+m+mi}{1}\PY{p}{,}\PY{l+m+mi}{4}\PY{p}{)}\PY{p}{)}
             \PY{c+c1}{\PYZsh{}svd and find the smallest eigenvalue (which is supposed to be 0)}
             ...
             \PY{n}{Pcol}\PY{o}{=}\PY{n}{vv}\PY{p}{[}\PY{n}{index}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{,}\PY{p}{:}\PY{p}{]}
             \PY{n}{P}\PY{o}{=}\PY{n}{Pcol}\PY{o}{.}\PY{n}{reshape}\PY{p}{(}\PY{l+m+mi}{3}\PY{p}{,}\PY{l+m+mi}{4}\PY{p}{)}
             
             \PY{n}{norm}\PY{o}{=}\PY{n}{np}\PY{o}{.}\PY{n}{sqrt}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{sum}\PY{p}{(}\PY{n}{P}\PY{o}{*}\PY{n}{P}\PY{p}{)}\PY{p}{)}
         
             \PY{k}{return} \PY{n}{P}\PY{o}{/}\PY{n}{norm}
         ...
         \PY{n}{P\PYZus{}DLT} \PY{o}{=} \PY{n}{computeP\PYZus{}DLT}\PY{p}{(}\PY{n}{x}\PY{p}{,}\PY{n}{X}\PY{p}{)}
...
criteria.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}8}]:} \PY{k}{def} \PY{n+nf}{sinc}\PY{p}{(}\PY{n}{x}\PY{p}{)}\PY{p}{:}
        ...
        \PY{k}{def} \PY{n+nf}{topavec}\PY{p}{(}\PY{n}{P}\PY{p}{)}\PY{p}{:}
            ...
            \PY{k}{return} \PY{n}{v}
        \PY{k}{def} \PY{n+nf}{Jacobian}\PY{p}{(}\PY{n}{X\PYZus{}nl}\PY{p}{,}\PY{n}{v}\PY{p}{)}\PY{p}{:}
            \PY{c+c1}{\PYZsh{}inputs}
            \PY{c+c1}{\PYZsh{}X 3D inhomogeneous coordinates }
            \PY{c+c1}{\PYZsh{}v parameterizated P}
         
            \PY{c+c1}{\PYZsh{}deparameterization}
            \PY{n}{P0}\PY{o}{=}\PY{n}{frompavec}\PY{p}{(}\PY{n}{v}\PY{p}{)}
            \PY{n}{p3}\PY{o}{=}\PY{n}{P0}\PY{p}{[}\PY{l+m+mi}{8}\PY{p}{:}\PY{l+m+mi}{12}\PY{p}{]}
            \PY{n}{norm}\PY{o}{=}\PY{n}{np}\PY{o}{.}\PY{n}{sqrt}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{dot}\PY{p}{(}\PY{n}{v}\PY{o}{.}\PY{n}{T}\PY{p}{,}\PY{n}{v}\PY{p}{)}\PY{p}{)}
            ...
            \PY{n}{x}\PY{o}{=}\PY{n}{proj}\PY{p}{(}\PY{n}{P0}\PY{o}{.}\PY{n}{reshape}\PY{p}{(}\PY{l+m+mi}{3}\PY{p}{,}\PY{l+m+mi}{4}\PY{p}{)}\PY{p}{,}\PY{n}{fromHomo}\PY{p}{(}\PY{n}{X\PYZus{}nl}\PY{p}{)}\PY{p}{)}
            \PY{c+c1}{\PYZsh{}calculate partialpv}
            \PY{k}{if} \PY{n}{norm}\PY{o}{==}\PY{l+m+mi}{0}\PY{p}{:}
                \PY{n}{partialav}\PY{o}{=}\PY{n}{np}\PY{o}{.}\PY{n}{zeros}\PY{p}{(}\PY{p}{(}\PY{l+m+mi}{11}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{)}\PY{p}{)}
                \PY{n}{partialbv}\PY{o}{=}\PY{l+m+mi}{1}\PY{o}{/}\PY{l+m+mi}{2}\PY{o}{*}\PY{n}{np}\PY{o}{.}\PY{n}{eye}\PY{p}{(}\PY{l+m+mi}{11}\PY{p}{,}\PY{l+m+mi}{11}\PY{p}{)}
            \PY{k}{else}\PY{p}{:}
                \PY{n}{partialav}\PY{o}{=}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{o}{/}\PY{l+m+mi}{2}\PY{o}{*}\PY{n}{b}\PY{o}{.}\PY{n}{T}
                \PY{n}{partialbv}\PY{o}{=}\PY{n}{sinc}\PY{p}{(}\PY{n}{norm}\PY{o}{/}\PY{l+m+mi}{2}\PY{p}{)}\PY{o}{/}\PY{l+m+mi}{2}\PY{o}{*}\PY{n}{np}\PY{o}{.}\PY{n}{eye}\PY{p}{(}\PY{l+m+mi}{11}\PY{p}{,}\PY{l+m+mi}{11}\PY{p}{)}\PY{o}{+}\PY{l+m+mi}{1}\PY{o}{/}\PY{l+m+mi}{4}\PY{o}{/}\PY{n}{norm}\PY{o}{*}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{cos}\PY{p}{(}\PY{n}{norm}\PY{o}{/}\PY{l+m+mi}{2}\PY{p}{)}\PY{o}{/}\PY{n}{norm}\PY{o}{*}\PY{l+m+mi}{2}\PYZbs{}
            ...
            \PY{c+c1}{\PYZsh{}calculate partialxp}
            \PY{n}{partialxp}\PY{o}{=}\PY{n}{np}\PY{o}{.}\PY{n}{zeros}\PY{p}{(}\PY{p}{(}\PY{l+m+mi}{100}\PY{p}{,}\PY{l+m+mi}{12}\PY{p}{)}\PY{p}{)}
            \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{l+m+mi}{50}\PY{p}{)}\PY{p}{:}
                \PY{n}{XT}\PY{o}{=}\PY{n}{X\PYZus{}nl}\PY{p}{[}\PY{p}{:}\PY{p}{,}\PY{n}{i}\PY{p}{]}\PY{o}{.}\PY{n}{reshape}\PY{p}{(}\PY{l+m+mi}{1}\PY{p}{,}\PY{l+m+mi}{4}\PY{p}{)}
                \PY{n}{w}\PY{o}{=}\PY{n}{XT}\PY{o}{.}\PY{n}{dot}\PY{p}{(}\PY{n}{p3}\PY{p}{)}
                \PY{n}{Ai}\PY{o}{=}\PY{n}{np}\PY{o}{.}\PY{n}{zeros}\PY{p}{(}\PY{p}{(}\PY{l+m+mi}{2}\PY{p}{,}\PY{l+m+mi}{12}\PY{p}{)}\PY{p}{)}
                \PY{n}{Ai}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{,}\PY{p}{:}\PY{l+m+mi}{4}\PY{p}{]}\PY{o}{=}\PY{n}{XT}
                \PY{n}{Ai}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{,}\PY{l+m+mi}{4}\PY{p}{:}\PY{l+m+mi}{8}\PY{p}{]}\PY{o}{=}\PY{n}{XT}
                \PY{n}{Ai}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{,}\PY{l+m+mi}{8}\PY{p}{:}\PY{l+m+mi}{12}\PY{p}{]}\PY{o}{=}\PY{o}{\PYZhy{}}\PY{n}{x}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{,}\PY{n}{i}\PY{p}{]}\PY{o}{*}\PY{n}{XT}
                \PY{n}{Ai}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{,}\PY{l+m+mi}{8}\PY{p}{:}\PY{l+m+mi}{12}\PY{p}{]}\PY{o}{=}\PY{o}{\PYZhy{}}\PY{n}{x}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{,}\PY{n}{i}\PY{p}{]}\PY{o}{*}\PY{n}{XT}
                \PY{n}{partialxp}\PY{p}{[}\PY{l+m+mi}{2}\PY{o}{*}\PY{n}{i}\PY{p}{:}\PY{l+m+mi}{2}\PY{o}{*}\PY{n}{i}\PY{o}{+}\PY{l+m+mi}{2}\PY{p}{,}\PY{p}{:}\PY{p}{]}\PY{o}{=}\PY{l+m+mi}{1}\PY{o}{/}\PY{n}{w}\PY{o}{*}\PY{n}{Ai}
            \PY{n}{J}\PY{o}{=}\PY{n}{partialxp}\PY{o}{.}\PY{n}{dot}\PY{p}{(}\PY{n}{partialpv}\PY{p}{)}
            \PY{k}{return} \PY{n}{J}    
        ...
        \PY{k}{def} \PY{n+nf}{LMstep}\PY{p}{(}\PY{n}{P}\PY{p}{,} \PY{n}{x}\PY{p}{,} \PY{n}{X}\PY{p}{,} \PY{n}{l}\PY{p}{,} \PY{n}{v}\PY{p}{)}\PY{p}{:}
            ...
            \PY{n}{x\PYZus{}homo}\PY{o}{=}\PY{n}{toHomo}\PY{p}{(}\PY{n}{x}\PY{p}{)}
            \PY{n}{X\PYZus{}homo}\PY{o}{=}\PY{n}{toHomo}\PY{p}{(}\PY{n}{X}\PY{p}{)}
            \PY{n}{x0mean}\PY{o}{=}\PY{n}{np}\PY{o}{.}\PY{n}{mean}\PY{p}{(}\PY{n}{x\PYZus{}homo}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{,}\PY{p}{:}\PY{p}{]}\PY{p}{)}
            \PY{n}{x1mean}\PY{o}{=}\PY{n}{np}\PY{o}{.}\PY{n}{mean}\PY{p}{(}\PY{n}{x\PYZus{}homo}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{,}\PY{p}{:}\PY{p}{]}\PY{p}{)}
            ...
            \PY{n}{sigma}\PY{o}{=}\PY{n}{np}\PY{o}{.}\PY{n}{sqrt}\PY{p}{(}\PY{n}{x0var}\PY{o}{*}\PY{o}{*}\PY{l+m+mi}{2}\PY{o}{+}\PY{n}{x1var}\PY{o}{*}\PY{o}{*}\PY{l+m+mi}{2}\PY{p}{)}
            ...
            \PY{n}{X0mean}\PY{o}{=}\PY{n}{np}\PY{o}{.}\PY{n}{mean}\PY{p}{(}\PY{n}{X\PYZus{}homo}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{,}\PY{p}{:}\PY{p}{]}\PY{p}{)}
            \PY{n}{X1mean}\PY{o}{=}\PY{n}{np}\PY{o}{.}\PY{n}{mean}\PY{p}{(}\PY{n}{X\PYZus{}homo}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{,}\PY{p}{:}\PY{p}{]}\PY{p}{)}
            \PY{n}{X2mean}\PY{o}{=}\PY{n}{np}\PY{o}{.}\PY{n}{mean}\PY{p}{(}\PY{n}{X\PYZus{}homo}\PY{p}{[}\PY{l+m+mi}{2}\PY{p}{,}\PY{p}{:}\PY{p}{]}\PY{p}{)}
            \PY{n}{X0var}\PY{o}{=}\PY{n}{np}\PY{o}{.}\PY{n}{var}\PY{p}{(}\PY{n}{X}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{,}\PY{p}{:}\PY{p}{]}\PY{p}{)}
            \PY{n}{X1var}\PY{o}{=}\PY{n}{np}\PY{o}{.}\PY{n}{var}\PY{p}{(}\PY{n}{X}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{,}\PY{p}{:}\PY{p}{]}\PY{p}{)}
            \PY{n}{X2var}\PY{o}{=}\PY{n}{np}\PY{o}{.}\PY{n}{var}\PY{p}{(}\PY{n}{X}\PY{p}{[}\PY{l+m+mi}{2}\PY{p}{,}\PY{p}{:}\PY{p}{]}\PY{p}{)}
            \PY{n}{sigma}\PY{o}{=}\PY{n}{np}\PY{o}{.}\PY{n}{sqrt}\PY{p}{(}\PY{n}{X0var}\PY{o}{*}\PY{o}{*}\PY{l+m+mi}{2}\PY{o}{+}\PY{n}{X1var}\PY{o}{*}\PY{o}{*}\PY{l+m+mi}{2}\PY{o}{+}\PY{n}{X2var}\PY{o}{*}\PY{o}{*}\PY{l+m+mi}{2}\PY{p}{)}
            \PY{n}{s3d}\PY{o}{=}\PY{n}{np}\PY{o}{.}\PY{n}{sqrt}\PY{p}{(}\PY{l+m+mi}{2}\PY{o}{/}\PY{p}{(}\PY{n}{sigma}\PY{o}{*}\PY{o}{*}\PY{l+m+mi}{2}\PY{p}{)}\PY{p}{)}
            \PY{n}{H3d}\PY{o}{=}\PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{p}{[}\PY{p}{[}\PY{n}{s3d}\PY{p}{,}\PY{l+m+mi}{0}\PY{p}{,}\PY{l+m+mi}{0}\PY{p}{,}\PY{o}{\PYZhy{}}\PY{n}{s3d}\PY{o}{*}\PY{n}{x0mean}\PY{p}{]}\PY{p}{,}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{,}\PY{n}{s3d}\PY{p}{,}\PY{l+m+mi}{0}\PY{p}{,}\PY{o}{\PYZhy{}}\PY{n}{s3d}\PY{o}{*}\PY{n}{x1mean}\PY{p}{]}\PY{p}{,}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{,}\PY{l+m+mi}{0}\PY{p}{,}\PY{n}{s3d}\PY{p}{,}\PY{o}{\PYZhy{}}\PY{n}{s3d}\PY{o}{*}\PY{n}{x1mean}\PY{p}{]}\PY{p}{,}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{,}\PY{l+m+mi}{0}\PY{p}{,}\PY{l+m+mi}{0}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{]}\PY{p}{)}
        
            \PY{n}{x\PYZus{}nl}\PY{o}{=}\PY{n}{H2d}\PY{o}{.}\PY{n}{dot}\PY{p}{(}\PY{n}{x\PYZus{}homo}\PY{p}{)}
            \PY{n}{X\PYZus{}nl}\PY{o}{=}\PY{n}{H3d}\PY{o}{.}\PY{n}{dot}\PY{p}{(}\PY{n}{X\PYZus{}homo}\PY{p}{)}
            
            \PY{n}{P\PYZus{}nl}\PY{o}{=}\PY{n}{H2d}\PY{o}{.}\PY{n}{dot}\PY{p}{(}\PY{n}{P}\PY{p}{)}\PY{o}{.}\PY{n}{dot}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{linalg}\PY{o}{.}\PY{n}{inv}\PY{p}{(}\PY{n}{H3d}\PY{p}{)}\PY{p}{)}
            \PY{n}{P\PYZus{}nl}\PY{o}{=}\PY{n}{P\PYZus{}nl}\PY{o}{/}\PY{n}{np}\PY{o}{.}\PY{n}{sqrt}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{sum}\PY{p}{(}\PY{n}{P\PYZus{}nl}\PY{o}{*}\PY{n}{P\PYZus{}nl}\PY{p}{)}\PY{p}{)}
        
            \PY{c+c1}{\PYZsh{}calculate Jacobian Matrix}
            \PY{n}{J}\PY{o}{=}\PY{n}{Jacobian}\PY{p}{(}\PY{n}{X\PYZus{}nl}\PY{p}{,}\PY{n}{topavec}\PY{p}{(}\PY{n}{P\PYZus{}nl}\PY{o}{.}\PY{n}{reshape}\PY{p}{(}\PY{l+m+mi}{12}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{)}\PY{p}{)}\PY{p}{)}
            
            \PY{c+c1}{\PYZsh{}calculate current error}
            \PY{n}{xproj}\PY{o}{=}\PY{n}{proj}\PY{p}{(}\PY{n}{P\PYZus{}nl}\PY{p}{,}\PY{n}{fromHomo}\PY{p}{(}\PY{n}{X\PYZus{}nl}\PY{p}{)}\PY{p}{)}
            \PY{n}{epsilon}\PY{o}{=}\PY{p}{(}\PY{n}{fromHomo}\PY{p}{(}\PY{n}{x\PYZus{}nl}\PY{p}{)}\PY{o}{\PYZhy{}}\PY{n}{xproj}\PY{p}{)}\PY{o}{.}\PY{n}{reshape}\PY{p}{(}\PY{p}{(}\PY{l+m+mi}{100}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{)}\PY{p}{,}\PY{n}{order}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{F}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
            \PY{n}{Sigmax}\PY{o}{=}\PY{n}{s2d}\PY{o}{*}\PY{o}{*}\PY{l+m+mi}{2}\PY{o}{*}\PY{n}{np}\PY{o}{.}\PY{n}{eye}\PY{p}{(}\PY{l+m+mi}{100}\PY{p}{,}\PY{l+m+mi}{100}\PY{p}{)}
            \PY{n}{error}\PY{o}{=}\PY{n}{epsilon}\PY{o}{.}\PY{n}{T}\PY{o}{.}\PY{n}{dot}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{linalg}\PY{o}{.}\PY{n}{inv}\PY{p}{(}\PY{n}{Sigmax}\PY{p}{)}\PY{p}{)}\PY{o}{.}\PY{n}{dot}\PY{p}{(}\PY{n}{epsilon}\PY{p}{)}
            \PY{n}{flag}\PY{o}{=}\PY{k+kc}{True}
            \PY{k}{while} \PY{n}{flag}\PY{p}{:}
                \PY{n}{delta}\PY{o}{=}\PY{n}{np}\PY{o}{.}\PY{n}{linalg}\PY{o}{.}\PY{n}{inv}\PY{p}{(}\PY{n}{J}\PY{o}{.}\PY{n}{T}\PY{o}{.}\PY{n}{dot}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{linalg}\PY{o}{.}\PY{n}{inv}\PY{p}{(}\PY{n}{Sigmax}\PY{p}{)}\PY{p}{)}\PY{o}{.}\PY{n}{dot}\PY{p}{(}\PY{n}{J}\PY{p}{)}\PY{o}{+}\PY{n}{l}\PY{o}{*}\PY{n}{np}\PY{o}{.}\PY{n}{eye}\PY{p}{(}\PY{l+m+mi}{11}\PY{p}{,}\PY{l+m+mi}{11}\PY{p}{)}\PY{p}{)}\PYZbs{}
                \PY{o}{.}\PY{n}{dot}\PY{p}{(}\PY{n}{J}\PY{o}{.}\PY{n}{T}\PY{o}{.}\PY{n}{dot}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{linalg}\PY{o}{.}\PY{n}{inv}\PY{p}{(}\PY{n}{Sigmax}\PY{p}{)}\PY{p}{)}\PY{o}{.}\PY{n}{dot}\PY{p}{(}\PY{n}{epsilon}\PY{p}{)}\PY{p}{)}
                \PY{n}{P\PYZus{}candidate}\PY{o}{=}\PY{n}{topavec}\PY{p}{(}\PY{n}{P\PYZus{}nl}\PY{o}{.}\PY{n}{reshape}\PY{p}{(}\PY{l+m+mi}{12}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{)}\PY{p}{)}\PY{o}{+}\PY{n}{delta}
                \PY{n}{xproj1}\PY{o}{=}\PY{n}{proj}\PY{p}{(}\PY{n}{frompavec}\PY{p}{(}\PY{n}{P\PYZus{}candidate}\PY{p}{)}\PY{o}{.}\PY{n}{reshape}\PY{p}{(}\PY{l+m+mi}{3}\PY{p}{,}\PY{l+m+mi}{4}\PY{p}{)}\PY{p}{,}\PY{n}{fromHomo}\PY{p}{(}\PY{n}{X\PYZus{}nl}\PY{p}{)}\PY{p}{)}
                \PY{n}{epsilon1}\PY{o}{=}\PY{p}{(}\PY{n}{fromHomo}\PY{p}{(}\PY{n}{x\PYZus{}nl}\PY{p}{)}\PY{o}{\PYZhy{}}\PY{n}{xproj1}\PY{p}{)}\PY{o}{.}\PY{n}{reshape}\PY{p}{(}\PY{p}{(}\PY{l+m+mi}{100}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{)}\PY{p}{,}\PY{n}{order}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{F}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
                \PY{n}{error\PYZus{}1}\PY{o}{=}\PY{n}{epsilon1}\PY{o}{.}\PY{n}{T}\PY{o}{.}\PY{n}{dot}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{linalg}\PY{o}{.}\PY{n}{inv}\PY{p}{(}\PY{n}{Sigmax}\PY{p}{)}\PY{p}{)}\PY{o}{.}\PY{n}{dot}\PY{p}{(}\PY{n}{epsilon1}\PY{p}{)}
                \PY{k}{if} \PY{n}{error\PYZus{}1}\PY{o}{\PYZlt{}}\PY{n}{error}\PY{p}{:}
                    \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{error = }\PY{l+s+s1}{\PYZsq{}}\PY{o}{+} \PY{n+nb}{str}\PY{p}{(}\PY{n}{error\PYZus{}1}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{)}\PY{p}{)}
                    \PY{n}{flag}\PY{o}{=}\PY{k+kc}{False}
                    \PY{n}{l}\PY{o}{=}\PY{l+m+mf}{0.1}\PY{o}{*}\PY{n}{l}
                \PY{k}{else}\PY{p}{:}
                    \PY{n}{l}\PY{o}{=}\PY{l+m+mi}{10}\PY{o}{*}\PY{n}{l}
            \PY{n}{P}\PY{o}{=}\PY{n}{frompavec}\PY{p}{(}\PY{n}{P\PYZus{}candidate}\PY{p}{)}\PY{o}{.}\PY{n}{reshape}\PY{p}{(}\PY{l+m+mi}{3}\PY{p}{,}\PY{l+m+mi}{4}\PY{p}{)}
            \PY{n}{P}\PY{o}{=}\PY{n}{np}\PY{o}{.}\PY{n}{linalg}\PY{o}{.}\PY{n}{inv}\PY{p}{(}\PY{n}{H2d}\PY{p}{)}\PY{o}{.}\PY{n}{dot}\PY{p}{(}\PY{n}{P}\PY{p}{)}\PY{o}{.}\PY{n}{dot}\PY{p}{(}\PY{n}{H3d}\PY{p}{)}
            \PY{n}{norm}\PY{o}{=}\PY{n}{np}\PY{o}{.}\PY{n}{sqrt}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{sum}\PY{p}{(}\PY{n}{P}\PY{o}{*}\PY{n}{P}\PY{p}{)}\PY{p}{)}
            \PY{k}{return} \PY{n}{P}\PY{o}{/}\PY{n}{norm}\PY{p}{,} \PY{n}{l}
        
        \PY{c+c1}{\PYZsh{} use P\PYZus{}DLT as an initalization for LM}
        \PY{n}{P\PYZus{}LM} \PY{o}{=} \PY{n}{P\PYZus{}DLT}\PY{o}{.}\PY{n}{copy}\PY{p}{(}\PY{p}{)}
        ...
        \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n}{max\PYZus{}iters}\PY{p}{)}\PY{p}{:}
            \PY{n}{P\PYZus{}LM}\PY{p}{,} \PY{n}{l} \PY{o}{=} \PY{n}{LMstep}\PY{p}{(}\PY{n}{P\PYZus{}LM}\PY{p}{,} \PY{n}{x}\PY{p}{,} \PY{n}{X}\PY{p}{,} \PY{n}{l}\PY{p}{,} \PY{n}{v}\PY{p}{)}
            \PY{n+nb}{print} \PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{iter }\PY{l+s+si}{\PYZpc{}d}\PY{l+s+s1}{ mean reprojection error }\PY{l+s+si}{\PYZpc{}f}\PY{l+s+s1}{\PYZsq{}}\PY{o}{\PYZpc{}}\PY{p}{(}\PY{n}{i}\PY{o}{+}\PY{l+m+mi}{1}\PY{p}{,} \PY{n}{rmse}\PY{p}{(}\PY{n}{x}\PY{p}{,}\PY{n}{proj}\PY{p}{(}\PY{n}{P\PYZus{}LM}\PY{p}{,}\PY{n}{X}\PY{p}{)}\PY{p}{)}\PY{p}{)}\PY{p}{)}
            
        \PY{n}{displayResults}\PY{p}{(}\PY{n}{P\PYZus{}LM}\PY{p}{,} \PY{n}{x}\PY{p}{,} \PY{n}{X}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{P\PYZus{}LM}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
\end{Verbatim}
